import {
  ...
  warning,
  warning_default
} from "./chunk-WWQLIRCT.js";
import {
  _extends,
  require_classnames
} from "./chunk-H7Z355TD.js";
import {
  require_react_dom
...
var OrderContext = React3.createContext(null);
...
var useId_default = useOriginId ? (
  ...
  function useCompatId(id) {
    var _React$useState = React7.useState("ssr-id"), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
function Mask(props) {
  ...
  return React9.createElement(es_default2, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
// node_modules/@rc-component/trigger/es/Popup/index.js
var Popup2 = React11.forwardRef(function(props, ref) {
  ...
  return React11.createElement(Portal2, {
    ...
    mask,
    motion: maskMotion
  }), React11.createElement(es_default, {
    onResize: onAlign,
    disabled: !open
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React16.useRef(open);
  openRef.current = open;
  var popupPointerDownRef = React16.useRef(false);
...
function generateTrigger() {
  ...
  var Trigger = React17.forwardRef(function(props, ref) {
    ...
    var _React$useState = React17.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mobile = _React$useState2[0], setMobile = _React$useState2[1];
    useLayoutEffect_default(function() {
      setMobile(isMobile_default());
    }, []);
    var subPopupElements = React17.useRef({});
    var parentContext = React17.useContext(context_default);
    ...
    var _React$useState3 = React17.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), popupEle = _React$useState4[0], setPopupEle = _React$useState4[1];
    var externalPopupRef = React17.useRef(null);
    ...
    var _React$useState5 = React17.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), targetEle = _React$useState6[0], setTargetEle = _React$useState6[1];
    var externalForwardRef = React17.useRef(null);
    ...
    var child = React17.Children.only(children);
    ...
    var _React$useState7 = React17.useState(defaultPopupVisible || false), _React$useState8 = _slicedToArray(_React$useState7, 2), internalOpen = _React$useState8[0], setInternalOpen = _React$useState8[1];
    ...
    var openRef = React17.useRef(mergedOpen);
    openRef.current = mergedOpen;
    var lastTriggerRef = React17.useRef([]);
    ...
    var _React$useState9 = React17.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), inMotion = _React$useState10[0], setInMotion = _React$useState10[1];
    useLayoutEffect_default(function(firstMount) {
      if (!firstMount || mergedOpen) {
        setInMotion(true);
      }
    }, [mergedOpen]);
    var _React$useState11 = React17.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), motionPrepareResolve = _React$useState12[0], setMotionPrepareResolve = _React$useState12[1];
    var _React$useState13 = React17.useState(null), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    var alignedClassName = React17.useMemo(function() {
    ...
    var _React$useState15 = React17.useState(0), _React$useState16 = _slicedToArray(_React$useState15, 2), targetWidth = _React$useState16[0], setTargetWidth = _React$useState16[1];
    var _React$useState17 = React17.useState(0), _React$useState18 = _slicedToArray(_React$useState17, 2), targetHeight = _React$useState18[0], setTargetHeight = _React$useState18[1];
    ...
    var renderedRef = React17.useRef(false);
    ...
    var triggerNode = React17.cloneElement(child, _objectSpread2(_objectSpread2({}, mergedChildrenProps), passedProps));
    var arrowPos = {
      x: arrowX,
      y: arrowY
    };
    var innerArrow = arrow ? _objectSpread2({}, arrow !== true ? arrow : {}) : null;
    return React17.createElement(React17.Fragment, null, React17.createElement(es_default, {
      disabled: !mergedOpen,
      ref: setTargetRef,
      onResize: onTargetResize
    }, React17.createElement(TriggerWrapper_default, {
      getTriggerDOMNode
    }, triggerNode)), renderedRef.current && React17.createElement(context_default.Provider, {
      value: context
    }, React17.createElement(Popup_default, {
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  var getPopupElement = function getPopupElement2() {
    return React18.createElement(Popup, {
      key: "content",
      prefixCls,
      id: mergedId,
  ...
  var getChildren = function getChildren2() {
    var child = React18.Children.only(children);
    ...
    return React18.cloneElement(children, childProps);
  };
  return React18.createElement(es_default4, _extends({
...
function useColorDrag(props) {
  ...
  var mouseMoveRef = (0, import_react6.useRef)(null);
  var mouseUpRef = (0, import_react6.useRef)(null);
...
var Transform = (0, import_react9.forwardRef)(function(props, ref) {
...
var Picker = function Picker2(_ref) {
  ...
  var pickerRef = (0, import_react10.useRef)();
...
var useColorState = function useColorState2(defaultValue, value) {
  ...
  var color = (0, import_react11.useMemo)(function() {
...
var Gradient = function Gradient2(_ref) {
  ...
  var gradientColors = (0, import_react12.useMemo)(function() {
...
var Slider = function Slider2(props) {
  ...
  var sliderRef = (0, import_react13.useRef)();
  var transformRef = (0, import_react13.useRef)();
  var colorRef = (0, import_react13.useRef)(color);
  ...
  var handleColor = import_react13.default.useMemo(function() {
    if (type === "hue") {
      var hsb = color.toHsb();
      hsb.s = 1;
      hsb.b = 1;
  ...
  var gradientList = import_react13.default.useMemo(function() {
  ...
  return import_react13.default.createElement("div", {
    ...
    onMouseDown: dragStartHandle,
    onTouchStart: dragStartHandle
  }, import_react13.default.createElement(Palette_default, {
    prefixCls
  }, import_react13.default.createElement(Transform_default, {
    x: offset.x,
    y: offset.y,
    ref: transformRef
  }, import_react13.default.createElement(Handler_default, {
    size: "small",
    color: handleColor.toHexString(),
    prefixCls
  })), import_react13.default.createElement(Gradient_default, {
    colors: gradientList,
    type,
    prefixCls
  })));
...
var ColorPicker = (0, import_react14.forwardRef)(function(props, ref) {
  ...
  var alphaColor = (0, import_react14.useMemo)(function() {
  ...
  var defaultPanel = import_react14.default.createElement(import_react14.default.Fragment, null, import_react14.default.createElement(Picker_default, _extends({
  ...
  }, import_react14.default.createElement(Slider3, _extends({}, sharedSliderProps, {
    type: "hue",
    colors: HUE_COLORS,
    min: 0,
    max: 359,
  ...
  })), !disabledAlpha && import_react14.default.createElement(Slider3, _extends({}, sharedSliderProps, {
    type: "alpha",
    colors: [{
      percent: 0,
  ...
  }))), import_react14.default.createElement(ColorBlock_default, {
...
var es_default6 = ColorPicker_default;
...
var PurePanel = (props) => {
  ...
  const cls = (0, import_classnames12.default)(hashId, cssVarCls, prefixCls, `${prefixCls}-pure`, `${prefixCls}-placement-${placement}`, className, colorInfo.className);
  return wrapCSSVar(React31.createElement("div", {
    className: cls,
    style: arrowContentStyle
  }, React31.createElement("div", {
    className: `${prefixCls}-arrow`
  }), React31.createElement(Popup, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var InternalTooltip = React32.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React32.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React32.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React32.createElement(ContextIsolator_default, {
    space: true
  ...
  const child = React32.isValidElement(children) && !isFragment(children) ? children : React32.createElement("span", null, children);
  const childProps = child.props;
  const childCls = !childProps.className || typeof childProps.className === "string" ? (0, import_classnames13.default)(childProps.className, openClassName || `${prefixCls}-open`) : childProps.className;
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, !injectFromPopover);
  const colorInfo = parseColor(prefixCls, color);
  const arrowContentStyle = colorInfo.arrowStyle;
  const rootClassNames = (0, import_classnames13.default)(overlayClassName, {
  ...
  const bodyClassNames = (0, import_classnames13.default)(contextClassNames.body, tooltipClassNames === null || tooltipClassNames === void 0 ? void 0 : tooltipClassNames.body);
  const [zIndex, contextZIndex] = useZIndex("Tooltip", restProps.zIndex);
  const content = React32.createElement(es_default5, Object.assign({}, restProps, {
    zIndex,
    ...
    arrowContent: React32.createElement("span", {
  ...
  return wrapCSSVar(React32.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, content));
});
...
var RefIcon2 = React33.forwardRef(EnterOutlined);
if (true) {
...
var Editable = (props) => {
  const {
    ...
    onEnd,
    component,
    enterIcon = React34.createElement(EnterOutlined_default2, null)
  } = props;
  const ref = React34.useRef(null);
  const inComposition = React34.useRef(false);
  const lastKeyCode = React34.useRef(null);
  const [current, setCurrent] = React34.useState(value);
  React34.useEffect(() => {
    setCurrent(value);
  }, [value]);
  React34.useEffect(() => {
  ...
  const textAreaClassName = (0, import_classnames14.default)(prefixCls, `${prefixCls}-edit-content`, {
    [`${prefixCls}-rtl`]: direction === "rtl",
  ...
  return wrapCSSVar(React34.createElement("div", {
    ...
    style
  }, React34.createElement(TextArea_default, {
    ref,
    maxLength,
    value: current,
    onChange,
...
var useCopyClick = ({
  ...
  const [copyLoading, setCopyLoading] = React35.useState(false);
  const copyIdRef = React35.useRef(null);
  const cleanCopyId = () => {
...
var useTooltipProps = (tooltip, editConfigText, children) => (0, import_react16.useMemo)(() => {
  if (tooltip === true) {
    return {
      title: editConfigText !== null && editConfigText !== void 0 ? editConfigText : children
    };
  }
  if ((0, import_react16.isValidElement)(tooltip)) {
    return {
      title: tooltip
    };
  }
...
var Typography = React37.forwardRef((props, ref) => {
  ...
  const [wrapCSSVar, hashId, cssVarCls] = style_default2(prefixCls);
  const componentClassName = (0, import_classnames15.default)(prefixCls, contextClassName, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  }, className, rootClassName, hashId, cssVarCls);
  const mergedStyle = Object.assign(Object.assign({}, contextStyle), style);
  return wrapCSSVar(
    // @ts-expect-error: Expression produces a union type that is too complex to represent.
    React37.createElement(Component, Object.assign({
...
var RefIcon3 = React38.forwardRef(CheckOutlined);
if (true) {
...
var RefIcon4 = React39.forwardRef(CopyOutlined);
if (true) {
...
var RefIcon5 = React40.forwardRef(LoadingOutlined);
if (true) {
...
var CopyBtn = ({
  ...
  return React41.createElement(tooltip_default, {
    title: copyTitle
  }, React41.createElement("button", {
    type: "button",
    className: (0, import_classnames16.default)(`${prefixCls}-copy`, {
    ...
    "aria-label": ariaLabel,
    tabIndex
  }, copied ? getNode(iconNodes[1], React41.createElement(CheckOutlined_default2, null), true) : getNode(iconNodes[0], btnLoading ? React41.createElement(LoadingOutlined_default2, null) : React41.createElement(CopyOutlined_default2, null), true)));
};
var CopyBtn_default = CopyBtn;

// node_modules/antd/es/typography/Base/Ellipsis.js
var React42 = __toESM(require_react());
var MeasureText = React42.forwardRef(({
  style,
  children
}, ref) => {
  const spanRef = React42.useRef(null);
...
function EllipsisMeasure(props) {
  ...
  const nodeList = React42.useMemo(() => toArray(text), [text]);
  const nodeLen = React42.useMemo(() => getNodesLen(nodeList), [text]);
  const fullContent = React42.useMemo(() => children(nodeList, false), [text]);
  const [ellipsisCutIndex, setEllipsisCutIndex] = React42.useState(null);
  const cutMidRef = React42.useRef(null);
  const measureWhiteSpaceRef = React42.useRef(null);
  const needEllipsisRef = React42.useRef(null);
  const descRowsEllipsisRef = React42.useRef(null);
  const symbolRowEllipsisRef = React42.useRef(null);
  const [canEllipsis, setCanEllipsis] = React42.useState(false);
  const [needEllipsis, setNeedEllipsis] = React42.useState(STATUS_MEASURE_NONE);
  const [ellipsisHeight, setEllipsisHeight] = React42.useState(0);
  const [parentWhiteSpace, setParentWhiteSpace] = React42.useState(null);
  useLayoutEffect_default(() => {
  ...
  const finalContent = React42.useMemo(() => {
    if (!enableMeasure) {
  ...
  return React42.createElement(React42.Fragment, null, finalContent, needEllipsis === STATUS_MEASURE_START && React42.createElement(React42.Fragment, null, React42.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
      WebkitLineClamp: rows
    }),
    ref: needEllipsisRef
  }, fullContent), React42.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
  ...
  }, children([], true))), needEllipsis === STATUS_MEASURE_NEED_ELLIPSIS && ellipsisCutIndex && ellipsisCutIndex[0] !== ellipsisCutIndex[1] && React42.createElement(MeasureText, {
    style: Object.assign(Object.assign({}, measureStyle), {
      top: 400
    }),
    ref: cutMidRef
  }, children(sliceNodes(nodeList, cutMidIndex), true)), needEllipsis === STATUS_MEASURE_PREPARE && React42.createElement("span", {
    style: {
      whiteSpace: "inherit"
    },
...
var EllipsisTooltip = ({
  ...
  return React43.createElement(tooltip_default, Object.assign({
...
function wrapperDecorations({
  ...
  function wrap(tag, needed) {
    ...
    currentContent = React44.createElement(tag, {}, currentContent);
  }
  wrap("strong", strong);
  wrap("u", underline);
  wrap("del", del);
...
var Base = React44.forwardRef((props, ref) => {
  var _a;
  const {
    prefixCls: customizePrefixCls,
    className,
  ...
  const typographyRef = React44.useRef(null);
  const editIconRef = React44.useRef(null);
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  ...
  const [isLineClampSupport, setIsLineClampSupport] = React44.useState(false);
  const [isTextOverflowSupport, setIsTextOverflowSupport] = React44.useState(false);
  const [isJsEllipsis, setIsJsEllipsis] = React44.useState(false);
  const [isNativeEllipsis, setIsNativeEllipsis] = React44.useState(false);
  const [isNativeVisible, setIsNativeVisible] = React44.useState(true);
  ...
  const needMeasureEllipsis = React44.useMemo(() => (
    // Disable ellipsis
  ...
  const [cssEllipsis, setCssEllipsis] = React44.useState(mergedEnableEllipsis);
  const canUseCssEllipsis = React44.useMemo(() => {
  ...
  const [ellipsisWidth, setEllipsisWidth] = React44.useState(0);
  const onResize = ({
    offsetWidth
  }) => {
  ...
  const topAriaLabel = React44.useMemo(() => {
  ...
  if (editing) {
    return React44.createElement(Editable_default, {
  ...
  const renderExpand = () => {
    ...
    return expandable ? React44.createElement("button", {
      type: "button",
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    return triggerType.includes("icon") ? React44.createElement(tooltip_default, {
      key: "edit",
      title: tooltip === false ? "" : editTitle
    }, React44.createElement("button", {
      type: "button",
      ref: editIconRef,
      ...
      "aria-label": ariaLabel,
      tabIndex
    }, icon || React44.createElement(EditOutlined_default2, {
      role: "button"
    }))) : null;
  };
  const renderCopy = () => {
    ...
    return React44.createElement(CopyBtn_default, Object.assign({
      key: "copy"
    }, copyConfig, {
      prefixCls,
      copied,
  ...
  const renderEllipsis = (canEllipsis) => [canEllipsis && !expanded && React44.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  }, ELLIPSIS_STR), ellipsisConfig.suffix, renderOperations(canEllipsis)];
  return React44.createElement(es_default, {
    onResize,
    disabled: !mergedEnableEllipsis
  }, (resizeRef) => React44.createElement(EllipsisTooltip_default, {
    tooltipProps,
    enableEllipsis: mergedEnableEllipsis,
    isEllipsis: isMergedEllipsis
  }, React44.createElement(Typography_default, Object.assign({
    ...
    title
  }, textProps), React44.createElement(EllipsisMeasure, {
  ...
  }, (node, canEllipsis) => wrapperDecorations(props, React44.createElement(React44.Fragment, null, node.length > 0 && canEllipsis && !expanded && topAriaLabel ? React44.createElement("span", {
    key: "show-content",
    "aria-hidden": true
...
var Link = React45.forwardRef((_a, ref) => {
  var {
    ellipsis,
    rel
  } = _a, restProps = __rest4(_a, ["ellipsis", "rel"]);
  if (true) {
  ...
  return React45.createElement(Base_default, Object.assign({}, mergedProps, {
    ref,
    ellipsis: !!ellipsis,
    component: "a"
  }));
...
//# sourceMappingURL=chunk-LONEHXV7.js.map
