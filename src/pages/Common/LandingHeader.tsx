    ...
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-3 flex items-center justify-between relative z-10">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm">
          {["Features", "About", "Pricing", "Contact", "Blog"].map(
            (item, index) => (
              <a
                key={index}
                href="#"
        ...
        <div className="flex items-center gap-3">
          <button
            className={`h-8 px-4 rounded-full text-sm transition-all duration-300 ${
              isScrolled
          ...
          <button
            className={`h-8 px-4 rounded-full text-sm font-medium transition-all duration-300 ${
              isScrolled
