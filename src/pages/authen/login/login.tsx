...
// Footer removed
import { loginWithUsernameOrEmail as apiLogin, setToken } from "../../../configs/authen"
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const token = data?.result?.token || data?.token || data?.access_token || data?.result?.accessToken || data?.result?.access_token;
      if (token) {
              ...
              <Card className="login-card">
                <Card.Body className="p-4 p-md-5">
                  <div className="text-center mb-4">
                    ...
                    <p className="login-subtitle text-muted">Vui lòng nhập phương thức đăng nhập của bạn</p>
                  </div>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Button type="submit" className="login-button w-100 mb-3" disabled={loading}>
